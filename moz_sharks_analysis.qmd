...
## Learning Hub Interactive | Coding in Action
...
## Learning Hub Description

For 30 years, NCEAS has been helping scientists turn complex data into discoveries that change how we understand and protect the natural world. The NCEAS Learning Hub carries this legacy forward by equipping researchers with the data science skills needed to tackle today’s environmental challenges. From species decline to climate adaptation, modern science increasingly depends on the ability to manage, share, and synthesize vast amounts of information. The Learning Hub opens the door to these skills, making them accessible to researchers at any career stage.

Through our courses, participants gain hands-on experience with tools that power collaborative, data-driven research. From computer programming in R, to project execution with GitHub, to best practices in data management, the Learning Hub emphasizes not just technical training, but the collaborative spirit that has always defined NCEAS’s approach to science. By teaching open, community-supported tools, the Hub helps researchers work more efficiently, transparently, and inclusively—ensuring that knowledge can be built and shared across projects, disciplines, and borders.
