...
The first part should read: How do we go from lines of letters and numbers to visuals that help data convey a story? From graphs to apps you use every day - like Instagram or Google Maps - coding is the engine behind much of what we see and interact with. Scientists rely on the same process to study the environment.
